...
async function run() {
    const urls = {
        CaptainMiller: await getImdbPoster("Captain Miller"),
        VadaChennai: await getImdbPoster("Vada Chennai")
    };
    fs.writeFileSync('missing_imdb_2.json', JSON.stringify(urls, null, 2));
}
